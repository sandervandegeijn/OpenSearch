...
### Fixed
- Fix file cache overflow in searchable snapshots by adding Cleaner-based reference tracking to FileCachedIndexInput ([#11676](https://github.com/opensearch-project/OpenSearch/issues/11676))
